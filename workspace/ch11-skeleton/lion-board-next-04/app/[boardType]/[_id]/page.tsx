      ...
      <section className="mb-8 p-4">
        ...
        <div className="font-semibold text-xl">제목 : {post.title}</div>
          ...
          <div className="flex justify-end my-4">
            <LinkButton href={`/${boardType}`} className="bg-orange-500 py-1 px-4 text-base text-white font-semibold ml-2 hover:bg-amber-400 rounded">목록</LinkButton>
            <LinkButton href={`/${boardType}/${_id}/edit`} className="bg-gray-900 py-1 px-4 text-base text-white font-semibold ml-2 hover:bg-amber-400 rounded">수정</LinkButton>
