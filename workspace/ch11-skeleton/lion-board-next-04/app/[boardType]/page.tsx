...
export default async function ListPage({ params }: { params: Promise<{ boardType: string , _id: string}>} ) { 
  const { boardType } = await params;
  ...
  return (
        ...
        <LinkButton href={`/${boardType}/new`} className="bg-orange-500 py-1 px-4 text-base text-white font-semibold ml-2 hover:bg-amber-400 rounded">글작성</LinkButton>
          </div>
