  ...
  return (
    <main className="flex-1 min-w-80 p-10">
      ...
      <div className="flex justify-end mr-4">
        ...
        <a href="/info/new" className="bg-orange-500 py-1 px-4 text-base text-white font-semibold ml-2 hover:bg-amber-400 rounded">
          글작성
        </a>
      </div>
          ...
          <tbody>
            <tr className="border-b border-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-300 ease-in-out">
              ...
              <td className="p-2 truncate indent-4">
                <a href="/info/2" className="hover:text-orange-500 hover:underline">
                  Next.js란?
                </a>
              </td>
            ...
            <tr className="border-b border-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-300 ease-in-out">
              ...
              <td className="p-2 truncate indent-4">
                <a href="/info/1" className="hover:text-orange-500 hover:underline">
                  React란?
                </a>
              </td>
