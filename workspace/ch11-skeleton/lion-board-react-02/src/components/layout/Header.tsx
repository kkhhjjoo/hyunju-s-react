        ...
        <div className="w-1/2 order-1 flex justify-end items-center md:order-2 md:w-auto">
          <form action="/">
            <p className="flex items-center">
              <img className="w-8 rounded-full mr-2" src="https://res.cloudinary.com/ddedslqvv/image/upload/v1767106161/user-jayg_i3nudk.webp" alt="용쌤 프로필 이미지" />
              용쌤님 :)
          ...
          <div className="flex justify-end">
            <Link to="/user/login" className="bg-orange-500 py-1 px-2 text-sm text-white font-semibold ml-2 hover:bg-amber-400 rounded">
              로그인
            </Link>
            <Link to="/user/signup" className="bg-gray-900 py-1 px-2 text-sm text-white font-semibold ml-2 hover:bg-amber-400 rounded">
              회원가입
            </Link>
          </div>
